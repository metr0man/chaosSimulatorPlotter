...
public class DefaultSetups {
	...
	public static void setup1(World world) {
		world.addMagnet(new Magnet(400,200,world.getDefaultCoef()));
		world.addMagnet(new Magnet(400,200,world.getDefaultCoef()));
		world.addMagnet(new Magnet(400,200,world.getDefaultCoef()));
		world.addMagnet(new Magnet(400,200,world.getDefaultCoef()));
		world.addMagnet(new Magnet(400,300,-world.getDefaultCoef()));
		world.addMagnet(new Magnet(300,300,-world.getDefaultCoef()));
		world.addMagnet(new Magnet(300,200,-world.getDefaultCoef()));
